...
public class IteratorMatchersUnitTest {
    ...
    public void factoryMethodContainsOnlyElementsThat() throws Exception {
        final Matcher<Iterator<Integer>> instance = containsOnlyElementsThat(MATCHER1, MATCHER2);
    ...
    public void factoryMethodContainsOnlyElements() throws Exception {
        final Matcher<Iterator<Integer>> instance = containsOnlyElements(MATCHER1, MATCHER2);
    ...
    public void factoryMethodContainsAtLeastOneElementThat() throws Exception {
        final Matcher<Iterator<Integer>> instance = containsAtLeastOneElementThat(MATCHER1, MATCHER2);
    ...
    public void factoryMethodContainsAtLeastOneElement() throws Exception {
        final Matcher<Iterator<Integer>> instance = containsAtLeastOneElement(MATCHER1, MATCHER2);
